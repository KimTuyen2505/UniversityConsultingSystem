...
export default function Home() {
  ...
  useEffect(() => {
    axios
      .post(env.API_URL + "/fetch-html", { link: url })
      .then((res) => {
  ...
  return (
    <div>
      <div className="relative items-center justify-center w-full lg:pt-40 overflow-hidden pb-96">
          ...
          <div className="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
            <div className="container relative left-0 w-full max-w-4xl lg:absolute xl:max-w-6xl lg:w-screen">
              <img
                ...
                className="w-full h-auto mt-20 mb-20 ml-0 lg:mt-24 xl:mt-96 lg:mb-0 lg:h-full lg:-ml-12"
              />
            </div>
          </div>
        </div>
          ...
          <div className="max-w-full mx-auto md:max-w-6xl sm:px-8">
            ...
            <div className="relative flex flex-col items-center sm:flex-row">
              ...
              <div className="relative z-0 w-11/12 max-w-sm my-8 rounded-lg shadow-lg sm:w-3/5 lg:w-1/3 sm:my-5 md:-ml-4">
                <div className="overflow-hidden text-black bg-white rounded-lg shadow-inner">
