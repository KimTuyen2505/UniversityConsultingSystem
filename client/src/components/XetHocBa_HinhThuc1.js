...
export default function XetHocBa_HinhThuc1({
  user,
  ...
  const columns = [
    ...
    {
      title: <div className="text-center">Điểm chuẩn học bạ (2023)</div>,
      key: "schoolProfileScore",
      render: (item) => {
        return <div className="text-center">{item.score_school_profile}</div>;
      },
    },
  ];
  ...
  const handleChange = (value) => {
        ...
        currentYourScore +=
          ((scores.HK1Lop11["ly"] +
            ...
            (scores.HK1Lop11["hoa"] +
              ...
              scores.HK1Lop12["hoa"]) /
              3 +
            (scores.HK1Lop11["sinh"] +
              scores.HK2Lop11["sinh"] +
              scores.HK1Lop12["sinh"]) /
              3) /
          3;
        ...
        currentYourScore +=
          ((scores.HK1Lop11["su"] +
            ...
            (scores.HK1Lop11["dia"] +
              ...
              scores.HK1Lop12["dia"]) /
              3 +
            (scores.HK1Lop11["gdcd"] +
              scores.HK2Lop11["gdcd"] +
              scores.HK1Lop12["gdcd"]) /
              3) /
          3;
      } else {
        currentYourScore +=
          (scores.HK1Lop11[major[i]] +
            scores.HK2Lop11[major[i]] +
            scores.HK1Lop12[major[i]]) /
          3;
      }
    }
    ...
    setDataMajor(
      maforSchoolProfileAndRatedCapacity
        .filter(
          (x) =>
            x.score_school_profile <= currentYourScore &&
            allMajor[x.major] &&
            allMajor[x.major].subjectCombination.includes(value)
        )
        .sort((a, b) => b.score_school_profile - a.score_school_profile)
    );
  };
  return (
    <div>
      <div className="text-xl font-bold text-center">
        PHƯƠNG THỨC XÉT HỌC BẠ (XÉT ĐIỂM TRUNG BÌNH CHUNG 3 HỌC KỲ (HK1, HK2 LỚP
        11 VÀ HK1 LỚP 12))
      </div>
      <Divider />
